// $ANTLR 3.4 Objcm.g 2012-11-15 20:53:35
...
public class ObjcmLexer extends Lexer {
    ...
    public final void mSIZEOF() throws RecognitionException {
        try {
            int _type = SIZEOF;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Objcm.g:1200:8: ( 'sizeof' )
            // Objcm.g:1200:10: 'sizeof'
            {
            match("sizeof"); 
    ...
    public final void mCONST_PREFIX() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Objcm.g:1205:3: ( 'const' )
            // Objcm.g:1205:5: 'const'
            {
            match("const"); 
    ...
    public final void mSTRUCT_PREFIX() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Objcm.g:1211:2: ( 'struct' )
            // Objcm.g:1211:4: 'struct'
            {
            match("struct"); 
    ...
    public final void mSTATIC_PREFIX() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Objcm.g:1214:2: ( 'static' )
            // Objcm.g:1214:4: 'static'
            {
            match("static"); 
    ...
    public final void mNUMBER() throws RecognitionException {
        try {
            int _type = NUMBER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Objcm.g:1225:9: ( ( DIGIT )+ ( 'u' | 'U' )? | ( DIGIT )+ DOT ( DIGIT )* ( 'f' | 'F' )? | ( DIGIT )* DOT ( DIGIT )+ ( 'f' | 'F' )? | ( '0x' ( DIGIT | 'A' .. 'F' )* ( DOT ( DIGIT )+ )? )? | ( DIGIT )+ ( DOT ( DIGIT )+ )? 'e' ( '-' | '+' )? ( DIGIT )+ )
            int alt29=5;
            alt29 = dfa29.predict(input);
            switch (alt29) {
                case 1 :
                    // Objcm.g:1225:11: ( DIGIT )+ ( 'u' | 'U' )?
                    {
                    // Objcm.g:1225:11: ( DIGIT )+
                    int cnt12=0;
                    loop12:
                    do {
                        int alt12=2;
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // Objcm.g:1227:4: ( DIGIT )* DOT ( DIGIT )+ ( 'f' | 'F' )?
                    {
                    // Objcm.g:1227:4: ( DIGIT )*
                    loop17:
                    do {
                        int alt17=2;
                    ...
                    break;
                case 4 :
                    // Objcm.g:1228:4: ( '0x' ( DIGIT | 'A' .. 'F' )* ( DOT ( DIGIT )+ )? )?
                    {
                    // Objcm.g:1228:4: ( '0x' ( DIGIT | 'A' .. 'F' )* ( DOT ( DIGIT )+ )? )?
                    int alt23=2;
                    ...
                    switch (alt23) {
                        case 1 :
                            // Objcm.g:1228:5: '0x' ( DIGIT | 'A' .. 'F' )* ( DOT ( DIGIT )+ )?
                            {
                            match("0x"); 



                            // Objcm.g:1228:11: ( DIGIT | 'A' .. 'F' )*
                            loop20:
                            do {
                                int alt20=2;
                            ...
                            switch (alt22) {
                                case 1 :
                                    // Objcm.g:1228:29: DOT ( DIGIT )+
                                    {
                                    mDOT(); 


                                    // Objcm.g:1228:33: ( DIGIT )+
                                    int cnt21=0;
                                    loop21:
                                    do {
                                        int alt21=2;
                    ...
                    break;
                case 5 :
                    // Objcm.g:1229:4: ( DIGIT )+ ( DOT ( DIGIT )+ )? 'e' ( '-' | '+' )? ( DIGIT )+
                    {
                    // Objcm.g:1229:4: ( DIGIT )+
                    int cnt24=0;
                    loop24:
                    do {
                        int alt24=2;
                    ...
                    switch (alt26) {
                        case 1 :
                            // Objcm.g:1229:12: DOT ( DIGIT )+
                            {
                            mDOT(); 


                            // Objcm.g:1229:16: ( DIGIT )+
                            int cnt25=0;
                            loop25:
                            do {
                                int alt25=2;
    ...
    public final void mSINGLE_OP() throws RecognitionException {
        try {
            int _type = SINGLE_OP;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Objcm.g:1234:2: ( 'continue' SEMICOLON )
            // Objcm.g:1234:4: 'continue' SEMICOLON
            {
            match("continue"); 
    ...
    public final void mBREAK_WORD() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Objcm.g:1238:2: ( 'break' )
            // Objcm.g:1238:4: 'break'
            {
            match("break"); 
    ...
    public final void mID() throws RecognitionException {
        try {
            int _type = ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Objcm.g:1242:4: ( LETTER ( DIGIT | LETTER )* )
            // Objcm.g:1242:6: LETTER ( DIGIT | LETTER )*
            {
            mLETTER(); 


            // Objcm.g:1242:13: ( DIGIT | LETTER )*
            loop31:
            do {
                int alt31=2;
    ...
    public final void mSTRING_LITERAL2() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Objcm.g:1248:2: ( '\"' ( WS | ESC |~ ( '\\r' | '\\n' | '\"' ) )* '\"' )
            // Objcm.g:1248:4: '\"' ( WS | ESC |~ ( '\\r' | '\\n' | '\"' ) )* '\"'
            {
            match('\"'); 

            // Objcm.g:1248:8: ( WS | ESC |~ ( '\\r' | '\\n' | '\"' ) )*
            loop32:
            do {
                int alt32=4;
    ...
    public final void mSTRING_LITERAL3() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Objcm.g:1251:2: ( '\\'' ( WS | ESC |~ ( '\\r' | '\\n' | '\\'' ) )* '\\'' )
            // Objcm.g:1251:4: '\\'' ( WS | ESC |~ ( '\\r' | '\\n' | '\\'' ) )* '\\''
            {
            match('\''); 

            // Objcm.g:1251:9: ( WS | ESC |~ ( '\\r' | '\\n' | '\\'' ) )*
            loop33:
            do {
                int alt33=4;
    ...
    public final void mSTRING_LITERAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Objcm.g:1253:16: ( ( '`' )? '@' STRING_LITERAL2 )
            // Objcm.g:1253:18: ( '`' )? '@' STRING_LITERAL2
            {
            // Objcm.g:1253:18: ( '`' )?
            int alt34=2;
    ...
    class DFA29 extends DFA {
        ...
        public String getDescription() {
            return "1225:1: NUMBER : ( ( DIGIT )+ ( 'u' | 'U' )? | ( DIGIT )+ DOT ( DIGIT )* ( 'f' | 'F' )? | ( DIGIT )* DOT ( DIGIT )+ ( 'f' | 'F' )? | ( '0x' ( DIGIT | 'A' .. 'F' )* ( DOT ( DIGIT )+ )? )? | ( DIGIT )+ ( DOT ( DIGIT )+ )? 'e' ( '-' | '+' )? ( DIGIT )+ );";
        }
    }
